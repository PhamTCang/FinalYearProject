...
public class ShipperSignUp extends AppCompatActivity {
    ...
    String lname, fname, email, password, confirmp, mobile, address, district, city, role = "Shipper";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fname = (TextInputLayout)findViewById(R.id.FirstnameShip);
        Lname = (TextInputLayout)findViewById(R.id.LastnameShip);
        Email = (TextInputLayout)findViewById(R.id.EmailShip);
        Password = (TextInputLayout)findViewById(R.id.PasswordShip);
        ConfirmP = (TextInputLayout)findViewById(R.id.ConfirmPwShip);
        Mobile = (TextInputLayout)findViewById(R.id.PhoneNumberShip);
        Address = (TextInputLayout)findViewById(R.id.AddressShip);

        CitySpin = (Spinner) findViewById(R.id.CitySpinnerSh);
        DistrictSpin = (Spinner) findViewById(R.id.DistrictSpinnerSh);


        Signup = (Button)findViewById(R.id.SignupbtnShip);
        SigninE = (Button)findViewById(R.id.EmailSignInSh);
        SigninP = (Button)findViewById(R.id.PhoneSignInSh);
        ...
        CitySpin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (city.equals("Ho Chi Minh")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ShipperSignUp.this, android.R.layout.simple_spinner_item,list);
        ...
        DBRef = FbDb.getInstance().getReference("Shipper");
        ...
        Signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(ShipperSignUp.this);
                    ...
                    FbAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                DBRef = FirebaseDatabase.getInstance().getReference("Shipper").child(userid);
                                ...
                                DBRef.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        FbDb.getInstance().getReference("Shipper")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FbAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()){
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(ShipperSignUp.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    //Verify phone number
                                                                    String PhoneNumberShip = Ccp.getSelectedCountryCodeWithPlus() + mobile;
                                                                    Intent verify = new Intent(ShipperSignUp.this,VerifyPhoneShipper.class);
                                                                    verify.putExtra("Phone Number Ship", PhoneNumberShip);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(ShipperSignUp.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
...
//
        ...
        SigninE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ShipperSignUp.this, ShipperSignInEmail.class));
                finish();
            }
        });
        ...
        SigninP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ShipperSignUp.this, ShipperSignInPhone.class));
                finish();
            }
        });
