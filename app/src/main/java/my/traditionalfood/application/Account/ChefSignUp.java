...
public class ChefSignUp extends AppCompatActivity {
    ...
    String lname, fname, email, password, confirmp, mobile, address, district, city, role = "Chef";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fname = (TextInputLayout)findViewById(R.id.FirstnameChef);
        Lname = (TextInputLayout)findViewById(R.id.LastnameChef);
        Email = (TextInputLayout)findViewById(R.id.EmailChef);
        Password = (TextInputLayout)findViewById(R.id.PasswordChef);
        ConfirmP = (TextInputLayout)findViewById(R.id.ConfirmPwChef);
        Mobile = (TextInputLayout)findViewById(R.id.PhoneNumberChef);
        Address = (TextInputLayout)findViewById(R.id.AddressChef);

        CitySpin = (Spinner) findViewById(R.id.CitySpinnerChef);
        DistrictSpin = (Spinner) findViewById(R.id.DistrictSpinnerChef);


        Signup = (Button)findViewById(R.id.SignupbtnChef);
        SigninE = (Button)findViewById(R.id.PhoneSignInCh);
        SigninP = (Button)findViewById(R.id.EmailSignInCh);

        Ccp = (CountryCodePicker)findViewById(R.id.CountryCodeChef);
        ...
        CitySpin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (city.equals("Ho Chi Minh")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefSignUp.this, android.R.layout.simple_spinner_item,list);
        ...
        DBRef = FbDb.getInstance().getReference("Chef");
        ...
        Signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(ChefSignUp.this);
                            ...
                            if (task.isSuccessful()){
                                ...
                                DBRef.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        FbDb.getInstance().getReference("Chef")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FbAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()){
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(ChefSignUp.this);
                                                            ...
                                                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent verify = new Intent(ChefSignUp.this,VerifyPhoneChef.class);
                                                                    verify.putExtra("Phone Number", PhoneNumber);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(ChefSignUp.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
...
//
        ...
        SigninE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ChefSignUp.this, ChefSignInEmail.class));
                finish();
            }
        });
        ...
        SigninP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ChefSignUp.this, ChefSignInPhone.class));
                finish();
            }
        });
    ...
    public boolean isValid(){
        ...
        if(TextUtils.isEmpty(confirmp)){
            ...
            if(!password.equals(confirmp)){
                ConfirmP.setErrorEnabled(true);
                ConfirmP.setError("Password Dosen't Match");
            }else{
