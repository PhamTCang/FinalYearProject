            ...
            public void run() {
                ...
                if(FbAuth.getCurrentUser()!=null){
                    if(FbAuth.getCurrentUser().isEmailVerified()){
                        ...
                        DbRef = FbDb.getInstance().getReference("User").child(FirebaseAuth.getInstance().getUid()+"/Role");
                        DbRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if(role.equals("Chef")){
                                    ...
                                    startActivity(new Intent(MainActivity.this, BottomNav_ChefFoodPanel.class));
                                    finish();
                                }

                                if(role.equals("Customer")){

                                    startActivity(new Intent(MainActivity.this, BottomNav_CusFoodPanel.class));
                                    finish();
                                }
                                if(role.equals("Shipper")){

                                    startActivity(new Intent(MainActivity.this, BottomNav_ShipFoodPanel.class));
                                    finish();
                                }
